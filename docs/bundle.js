...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _giphy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./giphy */ \"./src/giphy.js\");\n/* harmony import */ var _openWeather__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./openWeather */ \"./src/openWeather.js\");\n/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utility */ \"./src/utility.js\");\n\n\n\n\nfunction renderWeatherData(weather) {\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.log)(weather);\n\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"city\").textContent = weather.place;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"date\").textContent = weather.date;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-temp\").textContent = weather.temp;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-desc\").textContent = weather.description;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"min\").textContent = weather.min;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"max\").textContent = weather.max;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-feel\").textContent = weather.feels;\n\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"min-1\").textContent = weather.future[0].min;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"min-2\").textContent = weather.future[1].min;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"min-3\").textContent = weather.future[2].min;\n\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"max-1\").textContent = weather.future[0].max;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"max-2\").textContent = weather.future[1].max;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"max-3\").textContent = weather.future[2].max;\n\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-future-1-weekday\").textContent = weather.future[0].dt;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-future-2-weekday\").textContent = weather.future[1].dt;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.getElement)(\"weather-future-3-weekday\").textContent = weather.future[2].dt;\n}\n\n// place\n// date\n// temp\n// min\n// max\n// feels\n// description\n// future[]: {dt,min,max,}\n\nfunction renderGIFData(url) {\n    weatherImgElement.src = url;\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.log)(url);\n}\n\nasync function fetchAndRender(city, units) {\n    const weather = await (0,_openWeather__WEBPACK_IMPORTED_MODULE_1__.getWeatherData)(city, units);\n    const gif = await (0,_giphy__WEBPACK_IMPORTED_MODULE_0__.getGIFData)(weather.title);\n    renderGIFData(gif);\n    renderWeatherData(weather);\n}\n\nfunction search() {\n    weatherStatusElement.innerText = \"loading...\";\n    weatherTemperatureElement.innerText = \"loading...\";\n    weatherImgElement.src = \"images/loading.gif\";\n\n    const units = searchInputMetricElement.checked ? \"metric\" : \"imperial\";\n    const city = (0,_utility__WEBPACK_IMPORTED_MODULE_2__.normalize)(searchInputElement.value);\n\n    localStorage.setItem(\"city\", city);\n    localStorage.setItem(\"units\", units);\n\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.log)(units);\n\n    fetchAndRender(city, units);\n}\n\n// searchButtonElement.addEventListener(\"click\", search);\n\nlet city = localStorage.getItem(\"city\") || \"brasilia\";\nlet units = localStorage.getItem(\"units\") || \"imperial\";\n\n//fetchAndRender(city, units);\n\n(0,_openWeather__WEBPACK_IMPORTED_MODULE_1__.getCoords)(\"recife\").then((coords) => {\n    (0,_utility__WEBPACK_IMPORTED_MODULE_2__.log)(coords);\n    (0,_openWeather__WEBPACK_IMPORTED_MODULE_1__.getWeatherData)(coords, \"metric\").then((weather) => renderWeatherData(weather));\n});\n\n\n//# sourceURL=webpack:///./src/index.js?");
